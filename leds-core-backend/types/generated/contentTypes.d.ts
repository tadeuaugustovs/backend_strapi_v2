...
export interface ApiBolsaBolsa extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    financiador: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiFinanciadorFinanciador extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    bolsas: Schema.Attribute.Relation<'oneToMany', 'api::bolsa.bolsa'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    descricao: Schema.Attribute.Text;
...
export interface ApiFormacaoMembroFormacaoMembro
  extends Struct.CollectionTypeSchema {
  collectionName: 'formacao_membros';
  info: {
    displayName: 'formacaoMembro';
    pluralName: 'formacao-membros';
    singularName: 'formacao-membro';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    membro: Schema.Attribute.Relation<'manyToOne', 'api::membro.membro'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiMembroMembro extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    DISC: Schema.Attribute.String;
    discAdapt: Schema.Attribute.String;
    email: Schema.Attribute.Email;
    equipe_desejadas: Schema.Attribute.Relation<
      'manyToMany',
      'api::equipe-desejada.equipe-desejada'
    >;
    ...
    outra_infomacoes_membros: Schema.Attribute.Relation<
      'oneToMany',
      'api::outra-infomacoes-membro.outra-infomacoes-membro'
    >;
    planos_de_trabalho: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiOutraInfomacoesMembroOutraInfomacoesMembro
  extends Struct.CollectionTypeSchema {
  collectionName: 'outra_infomacoes_membros';
  info: {
    displayName: 'OutraInfomacoesMembro';
    pluralName: 'outra-infomacoes-membros';
    singularName: 'outra-infomacoes-membro';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiPlanoDeTrabalhoPlanoDeTrabalho
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    bolsa: Schema.Attribute.Relation<'manyToOne', 'api::bolsa.bolsa'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    membro: Schema.Attribute.Relation<'manyToOne', 'api::membro.membro'>;
    motivoInatividade: Schema.Attribute.Enumeration<
      ['CANCELAMENTO', 'PRAZO', 'PROMO\u00C7\u00C3O']
    >;
    observacoes: Schema.Attribute.Text;
    projetos: Schema.Attribute.Relation<'manyToMany', 'api::projeto.projeto'>;
    publishedAt: Schema.Attribute.DateTime;
    statusBolsa: Schema.Attribute.Enumeration<
      ['ATIVA', 'INATIVA', 'PLANEJADA']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiRedeSocialRedeSocial extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    membro: Schema.Attribute.Relation<'manyToOne', 'api::membro.membro'>;
    nomeRede: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSiteConfigSiteConfig extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    AgentESCover: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    backgroundLEDS: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    conectaFapesCover: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiSquadSquad extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    descricao: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::squad.squad'> &
      Schema.Attribute.Private;
    membros: Schema.Attribute.Relation<'manyToMany', 'api::membro.membro'>;
    nome: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
